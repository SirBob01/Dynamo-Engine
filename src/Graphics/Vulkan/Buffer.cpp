...
namespace Dynamo::Graphics::Vulkan {
    ...
    void Buffer::resize(unsigned size) {
        ...
        VkBuffer_copy(_handle, next_handle, _transfer_queue, _command_buffer, &region, 1);
    ...
    void Buffer::copy_to(Buffer &dst, VkBufferCopy *regions, unsigned region_count) {
        VkBuffer_copy(_handle, dst._handle, _transfer_queue, _command_buffer, regions, region_count);
        vkQueueWaitIdle(_transfer_queue);
    }
